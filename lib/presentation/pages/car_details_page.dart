...
import 'package:flash_rent/presentation/pages/MapsDetailsPage.dart';
import 'package:flash_rent/presentation/widgets/car_card.dart';
import 'package:flash_rent/presentation/widgets/more_card.dart';
                  ...
                  child: Container(
                    ...
                    child: Column(
                      children: [
                        ...
                        SizedBox(height: 10,),
                        Text('Johny Walker',style: TextStyle(fontWeight: FontWeight.bold),),
                        Text('\$2,253',style: TextStyle(color: Colors.grey),),
                      ],
                    ),
                  ),
                ),
